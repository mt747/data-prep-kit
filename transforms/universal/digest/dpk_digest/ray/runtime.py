...
from dpk_digest.runtime import DigestTransformConfiguration

logger = get_logger(__name__)

class DigestRayTransformConfiguration(RayTransformRuntimeConfiguration):
    def __init__(self):
...
class Digest:
    ...
    def transform(self):
        ...
        launcher = RayTransformLauncher(DigestRayTransformConfiguration())
